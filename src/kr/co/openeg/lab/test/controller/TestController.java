...
public class TestController {
	...
	public String testEncoding(HttpServletRequest request) {
		...
		case 4:
			buffer.append("HTML 인코딩 테스트: "+TestUtil.htmlEncoder(data)); break;
		case 5:
	...
	public String testRegEx(HttpServletRequest request) {
		...
		//		String regex="[a-zA-Z0-9._]+@([a-zA-Z][a-zA-Z0-9_]*\\.){1,2}[a-z]{2,3}";
		...
		if(matcher.find()){
			buffer.append("입력값에 인코딩 적용 : "+TestUtil.htmlEncoder(data));
		} else{
